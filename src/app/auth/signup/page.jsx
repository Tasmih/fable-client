            ...
            <div className="flex flex-col gap-4">
                ...
                {isOpen && (
                  <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-md shadow-lg py-1">
                    <button
                      ...
                      className={`w-full flex items-center gap-2 px-3 py-2 text-sm text-left hover:bg-[#F7F5F2] transition ${
                        role === "user"
                          ? "bg-[#2F6F6D]/5 font-medium text-[#2F6F6D]"
                          : "text-gray-700"
                      }`}
                    >
                      <BookOpen className="h-4 w-4 text-[#2F6F6D]" />
                    ...
                    <button
                      ...
                      className={`w-full flex items-center gap-2 px-3 py-2 text-sm text-left hover:bg-[#F7F5F2] transition ${
                        role === "writer"
                          ? "bg-[#AE7C54]/5 font-medium text-[#AE7C54]"
                          : "text-gray-700"
                      }`}
                    >
                      <PenTool className="h-4 w-4 text-[#AE7C54]" />
              ...
              >
                {isLoading ? (
                  ...
                  <span>
                    {role === "user"
                      ? "Create Fable Account"
                      : "Join as Fable Writer"}
                  </span>
                )}
              </button>
            </div>
