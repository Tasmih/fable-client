...
import { House, OctagonXmark } from "@gravity-ui/icons";
...
export default function ForbiddenPage() {
  ...
  <OctagonXmark className="h-11 w-11" />
</div>
        ...
        <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-[#053c41]/70">
          This section is protected. Your current role cannot perform this
          action or view this page.
        </p>
